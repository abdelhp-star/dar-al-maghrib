...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.legacy_p1': 'Founded in 1998, Dar Al Maghrib began as a humble family kitchen, sharing the rich, complex flavors of Safi with our local community. Over two decades later, we continue to honor the timeless recipes passed down through generations.',
  ...
  fr: {
    ...
    'about.legacy_p1': "Fondé en 1998, Dar Al Maghrib a débuté comme une modeste cuisine familiale, partageant les saveurs riches et complexes de Safi avec notre communauté locale. Plus de deux décennies plus tard, nous continuons d'honorer les recettes intemporelles transmises de génération en génération.",
  ...
  ar: {
    ...
    'about.legacy_p1': 'تأسست دار المغرب عام 1998 كمطبخ عائلي متواضع، يشارك النكهات الغنية والمعقدة لآسفي مع مجتمعنا المحلي. وبعد أكثر من عقدين، نواصل تكريم الوصفات الخالدة المتوارثة عبر الأجيال.',
