...
const CATEGORIES = [
  ...
  { id: 5,  name: "Grilled Food",         name_ar: "المشويات",                     name_fr: "Grillades",                         icon: "🍖", image_url: null, sort_order: 5,  active: true },
  { id: 6,  name: "Sandwiches",           name_ar: "السندويشات",                   name_fr: "Sandwichs",                         icon: "🥪", image_url: null, sort_order: 6,  active: true },
  { id: 7,  name: "Pizza",               name_ar: "البيتزا",                       name_fr: "Pizza",                             icon: "🍕", image_url: null, sort_order: 7,  active: true },
  { id: 8,  name: "Burgers",             name_ar: "البرغر",                        name_fr: "Burgers",                           icon: "🍔", image_url: null, sort_order: 8,  active: true },
  ...
  { id: 10, name: "Juices",             name_ar: "العصائر",                        name_fr: "Jus",                               icon: "🥤", image_url: null, sort_order: 10, active: true },
  { id: 11, name: "Coffee",             name_ar: "القهوة",                         name_fr: "Café",                              icon: "☕", image_url: null, sort_order: 11, active: true },
...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 9,  name: "Moroccan Cream Bastilla",                         name_ar: "بسطيلة بالكريمة",                                 name_fr: "Bastilla Crème",                                      description: "Sweet layered pastry filled with milk cream, almonds and rose water, dusted with cinnamon",                                                                      description_ar: "فطيرة حلوة بطبقات محشوة بكريمة الحليب واللوز وماء الورد ومرشوشة بالقرفة",                       description_fr: "Pâtisserie feuilletée sucrée garnie de crème de lait, amandes et eau de rose, saupoudrée de cannelle", price: "40.00", image_url: null,                                                                                                 category_id: 9,  available: true, spice_level: "none",   preparation_time: 20, calories: 380, ingredients: "Phyllo dough, milk cream, almonds, rose water, cinnamon, sugar",                                    is_popular: false, is_featured: true,  is_today_special: false },
  { id: 10, name: "Fresh Orange Juice",                              name_ar: "عصير البرتقال الطازج",                            name_fr: "Jus d'Orange Frais",                                  description: "Freshly squeezed Moroccan oranges, sweet and full of vitamin C",                                                                                                 description_ar: "عصير البرتقال المغربي الطازج الحلو والغني بفيتامين سي",                                        description_fr: "Oranges marocaines fraîchement pressées, sucrées et riches en vitamine C",                          price: "18.00",  image_url: "https://images.unsplash.com/photo-1707217361278-02cf3c6615f8?w=800&auto=format&fit=crop&q=80",              category_id: 10, available: true, spice_level: "none",   preparation_time: 5,  calories: 90,  ingredients: "Fresh oranges",                                                                                    is_popular: true,  is_featured: false, is_today_special: false },
  { id: 11, name: "Avocado Smoothie",                                name_ar: "عصير الأفوكادو",                                  name_fr: "Smoothie à l'Avocat",                                 description: "Creamy blended avocado with cold milk, honey and a hint of vanilla",                                                                                             description_ar: "أفوكادو كريمي ممزوج مع الحليب البارد والعسل وقليل من الفانيليا",                               description_fr: "Avocat crémeux mixé avec du lait froid, du miel et une touche de vanille",                          price: "25.00",  image_url: "https://images.unsplash.com/photo-1557753478-d111aef068be?w=800&auto=format&fit=crop&q=80",              category_id: 10, available: true, spice_level: "none",   preparation_time: 5,  calories: 210, ingredients: "Avocado, cold milk, honey, vanilla, ice",                                                         is_popular: true,  is_featured: false, is_today_special: true },
  { id: 12, name: "Moroccan Mint Tea",                               name_ar: "الشاي المغربي بالنعناع",                          name_fr: "Thé Marocain à la Menthe",                            description: "The classic Moroccan welcome — gunpowder green tea brewed with fresh mint and honey, poured from a height",                                                      description_ar: "الترحيب المغربي الكلاسيكي - شاي أخضر مخمر بالنعناع الطازج والعسل، يصب من ارتفاع",             description_fr: "Le classique bienvenu marocain — thé vert brassé avec de la menthe fraîche et du miel, versé de hauteur", price: "12.00", image_url: "https://images.pexels.com/photos/37118006/pexels-photo-37118006.jpeg?auto=compress&cs=tinysrgb&w=800", category_id: 12, available: true, spice_level: "none", preparation_time: 5, calories: 35, ingredients: "Gunpowder green tea, fresh mint, sugar",                                                              is_popular: true,  is_featured: true,  is_today_special: false },
