...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 11, name: "Avocado Smoothie",                                name_ar: "عصير الأفوكادو",                                  name_fr: "Smoothie à l'Avocat",                                 description: "Creamy blended avocado with cold milk, honey and a hint of vanilla",                                                                                             description_ar: "أفوكادو كريمي ممزوج مع الحليب البارد والعسل وقليل من الفانيليا",                               description_fr: "Avocat crémeux mixé avec du lait froid, du miel et une touche de vanille",                          price: "25.00",  image_url: "/dishes/avocado-smoothie.png",              category_id: 10, available: true, spice_level: "none",   preparation_time: 5,  calories: 210, ingredients: "Avocado, cold milk, honey, vanilla, ice",                                                         is_popular: true,  is_featured: false, is_today_special: true },
